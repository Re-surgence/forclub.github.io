...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Optional club_name (if you decide to add it later)
    // $club_name = isset($_POST['club_name']) ? $_POST['club_name'] : NULL;
    ...
    if (empty($email) || empty($pass)) {
        ...
        if (mysqli_stmt_num_rows($stmt) > 0) {
            ...
            // Insert the new user into the database (without club_name for now)
...
<body>
    <section class="page">
        <div class="cont">
            ...
            <form method="post" action="login.php" class="forform">
                <div class="input-box">
                    <label for="name" class="forlabel">Name</label><br>
                    <input type="text" name="name" id="name" class="box" required><br>
                </div>
                <div class="input-box">
                    <label for="uname" class="forlabel">Username</label><br>
                    <input type="text" name="uname" id="uname" class="box" required><br>
                </div>
                <div class="input-box">
